...
num10 = eval(input("Ingrese número 10: "))

# Condiciones
if num1 == 0 or num2 == 0 or num3 == 0 or num4 == 0 or num5 == 0 or num6 == 0 or num7 == 0 or num8 == 0 or num9 == 0 or num10 == 0 or num1 < 0 or num2 < 0 or num3 < 0 or num4 < 0 or num5 < 0 or num6 < 0 or num7 < 0 or num8 < 0 or num9 < 0 or num10 < 0:
    print("Datos no validos...")
    print("Deben ser números diferentes de 0...")
    print("Deben ser números positivos...")
else:
    # Número mayor
    ...
    print("Suma de números pares: ", sumaNumImpares)
